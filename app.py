...
ARTIKEL_DATA = [
    {
        ...
        "isi": [
            ...
            tr("Kegiatan dilaksanakan oleh Melda Fitri Ayu Rosada, Program Studi Informasi dan Humas, Sekolah Vokasi Universitas Diponegoro, dengan berkoordinasi langsung bersama pelaku UMKM minuman gones, Ibu Inti Kurniati. Koordinasi dilakukan untuk mengetahui tahapan produksi sekaligus menentukan proses yang akan didokumentasikan.", "The activity was carried out by Melda Fitri Ayu Rosada, Information and Public Relations Study Program, Vocational School of Diponegoro University, by coordinating directly with the Gones beverage MSME actor, Ibu Inti Kurniati. Coordination was carried out to understand the production stages as well as to determine the processes to be documented."),
